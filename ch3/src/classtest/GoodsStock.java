...
public class GoodsStock {
	...
	// 기능 : 재고추가 : 재고수량을 입력받아서 현재 재고수량에 추가하기 / 현재 재고수량이 얼마인지 보내기
	int addStock(int amount) { //int amount : 재고수량
		stockNum += amount; // stockNum = stockNum + amount
		return stockNum; // return : 메소드를 호출한 곳으로 값을 보내기
	}
	
	// 기능 : 재고감소 : 판매수량을 입력받아서 현재 재고수량에서 감소하기 / 현재 재고수량 리턴
