...
//		}
		...
		for (int i = 0; i < words.length; i++) {
			...
			char question[] = words[i].toCharArray(); //toCharArray : String을 char로 바꿔줌! 
			// 변경 후 자리 교환
			...
			System.out.printf("(Q%d ) %s 의 정답을 입력하세요 >>",(i+1),new String(question)); // new String() : char을 문자열로 바꿔주는 기능
