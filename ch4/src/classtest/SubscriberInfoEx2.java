...
public class SubscriberInfoEx2 {
	...
	public static void main(String[] args) {
		...
		//기본 타입(byte,short,char,boolean..)의 초기화는 null 줄 수 없음
		//대문자로 시작하는 타입은 null을 줄 수 있음
		//소문자로 시작하는 타입은 null을 줄 수 없음
//		int a = null;
		...
		SubscriberInfo info[] = new SubscriberInfo[3]; //null 상태
	...
	static void print(SubscriberInfo info[]) { //참조매개
		//for (타입 변수명:배열명) {
